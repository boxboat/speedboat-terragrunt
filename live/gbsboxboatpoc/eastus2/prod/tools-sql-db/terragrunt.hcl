...
terraform {
    source = "../../../../..//terraform//templates/postgresql"
}
...
dependency "tools_cluster" {
  config_path = "../tools-cluster"
}
...
inputs = merge(
    ...
    {
        resource_group_name = dependency.tools_cluster.outputs.resource_group.name
        tags = merge(
